...
public class AddOrderBaseAdapter extends BaseExpandableListAdapter {
     ...
     * be adapted to be displayed in the ExpandableListView in the AddOrderActivity.
     */
    public AddOrderBaseAdapter(Context context, ArrayList<String> categories, HashMap<String, ArrayList<MenuItemWithQuantity>> menuItemsWithQuantityByCategory) {
    ...
    public View getChildView(final int i, final int i1, boolean b, View view, final ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.item_menu_item_with_quantity_changable, viewGroup, false);
        }

        // Bring XML elements from the single child view to Java.
        TextView textViewName = view.findViewById(R.id.text_view_menu_item_with_quantity_name);
        TextView textViewPrice = view.findViewById(R.id.text_view_menu_item_with_quantity_price);
        TextView textViewQuantity = view.findViewById(R.id.text_view_menu_item_with_quantity_quantity);
        Button buttonIncrement = view.findViewById(R.id.button_menu_item_with_quantity_increment);
        Button buttonDecrement = view.findViewById(R.id.button_menu_item_with_quantity_decrement);
        ...
        final int flatPosition = ((ExpandableListView) viewGroup).getFlatListPosition(packedPosition);

        // Handle increment and decrement Button clicks in AddOrderActivity.
        buttonIncrement.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((ExpandableListView) viewGroup).performItemClick(view, flatPosition, 0);
            }
        });
